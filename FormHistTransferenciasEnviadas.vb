...
Public Class FormHistTransferenciasEnviadas
    ...
    Private Sub FormHistTransferencias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            cmd.CommandText = "select ID_Remetente, ID_Destinatario, Valor_Enviado, Dia_Envio, Hora_Envio from " & Table & " where ID_Remetente LIKE '" & FormUtilizador.IDutilizador & "'" & "ORDER BY Dia_Envio DESC, Hora_Envio DESC"
    ...
    Private Sub grupo1auto()
        ...
        cmdnome.CommandText = "select Nome, Pin, Dinheiro,Id from vbnet_mysql_mb_table where ID LIKE '" & dt.Rows(0)(1) & "'"
    ...
    Private Sub grupo2auto()
        cmdnome.CommandType = CommandType.Text
        cmdnome.CommandText = "select Nome, Pin, Dinheiro,Id from vbnet_mysql_mb_table where ID LIKE '" & dt.Rows(1)(1) & "'"
        sdanome = New MySqlDataAdapter(cmdnome.CommandText, con)
        dtnome = New DataTable
        sdanome.Fill(dtnome)
        cmdnome.CommandType = CommandType.Text
    ...
    Private Sub grupo3auto()
        cmdnome.CommandType = CommandType.Text
        cmdnome.CommandText = "select Nome, Pin, Dinheiro,Id from vbnet_mysql_mb_table where ID LIKE '" & dt.Rows(2)(1) & "'"
        sdanome = New MySqlDataAdapter(cmdnome.CommandText, con)
        dtnome = New DataTable
        ...
        Label3DiaEnvio.Text = dt.Rows(2)(3)
        Label3HoradoEnvio.Text = dt.Rows(2)(4)
    End Sub
    Private Sub grupo1()
        cmdnome.CommandType = CommandType.Text
        cmdnome.CommandText = "select Nome, Pin, Dinheiro,Id from vbnet_mysql_mb_table where ID LIKE '" & dt.Rows(j)(1) & "'"
        sdanome = New MySqlDataAdapter(cmdnome.CommandText, con)
        dtnome = New DataTable
    ...
    Private Sub grupo2()
        cmdnome.CommandType = CommandType.Text
        cmdnome.CommandText = "select Nome, Pin, Dinheiro,Id from vbnet_mysql_mb_table where ID LIKE '" & dt.Rows(j + 1)(1) & "'"
        sdanome = New MySqlDataAdapter(cmdnome.CommandText, con)
        dtnome = New DataTable
    ...
    Private Sub grupo3()
        cmdnome.CommandType = CommandType.Text
        cmdnome.CommandText = "select Nome, Pin, Dinheiro,Id from vbnet_mysql_mb_table where ID LIKE '" & dt.Rows(j + 2)(1) & "'"
        sdanome = New MySqlDataAdapter(cmdnome.CommandText, con)
        dtnome = New DataTable
